...
public class CollectResearchMission : BaseMission
{
    ...
    void Start()
    {
        ...
        missionDescription = "Collect research by holding on an object for " + holdTime + " seconds.";
        missionTextScript = FindObjectOfType<MissionText>();
        if (missionTextScript != null)
        {
            missionTextScript.SetMissionStatus("Collect Research: not done");
        }
    ...
    {
        isHolding = true;
        UpdateMissionUI("Hold 'E' to collect research...");
    }
    ...
    private void CompleteMission()
    {
        ...
        if (missionTextScript != null)
        {
            missionTextScript.SetMissionStatus("Collect Research: done");
        }
    }
